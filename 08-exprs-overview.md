...
\caption{Schematic representation of PCA dimensionality reduction (taken from [here](http://www.nlpca.org/pca_principal_component_analysis.html))}(\#fig:clust-pca)
\end{figure}
...
{\centering \includegraphics[width=0.9\linewidth]{08-exprs-overview_files/figure-latex/expr-overview-pca-before-qc-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{08-exprs-overview_files/figure-latex/expr-overview-pca-after-qc-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{08-exprs-overview_files/figure-latex/expr-overview-pca-after-qc-exercise1-1-1} 

}

\caption{PCA plot of the blischak data (14214 genes)}(\#fig:expr-overview-pca-after-qc-exercise1-1)
\end{figure}

\begin{figure}

{\centering \includegraphics[width=0.9\linewidth]{08-exprs-overview_files/figure-latex/expr-overview-pca-after-qc-exercise1-2-1} 

}

\caption{PCA plot of the blischak data (50 genes)}(\#fig:expr-overview-pca-after-qc-exercise1-2)
\end{figure}
...
{\centering \includegraphics[width=0.9\linewidth]{08-exprs-overview_files/figure-latex/expr-overview-tsne-before-qc-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{08-exprs-overview_files/figure-latex/expr-overview-tsne-after-qc-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{08-exprs-overview_files/figure-latex/expr-overview-tsne-after-qc-exercise2-1-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{08-exprs-overview_files/figure-latex/expr-overview-tsne-after-qc-exercise2-2-1} 
