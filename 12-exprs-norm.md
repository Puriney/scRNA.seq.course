...
{\centering \includegraphics[width=0.9\linewidth]{12-exprs-norm_files/figure-latex/norm-pca-raw-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{12-exprs-norm_files/figure-latex/norm-ours-rle-raw-1} 

}

\caption{Cell-wise RLE of the blischak data}(\#fig:norm-ours-rle-raw)
\end{figure}
...
{\centering \includegraphics[width=0.9\linewidth]{12-exprs-norm_files/figure-latex/norm-pca-cpm-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{12-exprs-norm_files/figure-latex/norm-ours-rle-cpm-1} 

}

\caption{Cell-wise RLE of the blischak data}(\#fig:norm-ours-rle-cpm)
\end{figure}
...
{\centering \includegraphics[width=0.9\linewidth]{12-exprs-norm_files/figure-latex/norm-pca-tmm-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{12-exprs-norm_files/figure-latex/norm-ours-rle-tmm-1} 

}

\caption{Cell-wise RLE of the blischak data}(\#fig:norm-ours-rle-tmm)
\end{figure}
...
{\centering \includegraphics[width=0.9\linewidth]{12-exprs-norm_files/figure-latex/norm-pca-lsf-1} 

}

\caption{PCA plot of the blischak data after LSF normalisation}(\#fig:norm-pca-lsf)
\end{figure}
...
{\centering \includegraphics[width=0.9\linewidth]{12-exprs-norm_files/figure-latex/norm-ours-rle-scran-1} 

}

\caption{Cell-wise RLE of the blischak data}(\#fig:norm-ours-rle-scran)
\end{figure}
...
{\centering \includegraphics[width=0.9\linewidth]{12-exprs-norm_files/figure-latex/norm-pca-rle-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{12-exprs-norm_files/figure-latex/norm-ours-rle-rle-1} 

}

\caption{Cell-wise RLE of the blischak data}(\#fig:norm-ours-rle-rle)
\end{figure}
...
{\centering \includegraphics[width=0.9\linewidth]{12-exprs-norm_files/figure-latex/norm-pca-uq-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{12-exprs-norm_files/figure-latex/norm-ours-rle-uq-1} 

}

\caption{Cell-wise RLE of the blischak data}(\#fig:norm-ours-rle-uq)
\end{figure}
## Downsampling 
...
{\centering \includegraphics[width=0.9\linewidth]{12-exprs-norm_files/figure-latex/norm-pca-downsample-1} 

}

\caption{PCA plot of the blischak data after downsampling}(\#fig:norm-pca-downsample)
\end{figure}
...
{\centering \includegraphics[width=0.9\linewidth]{12-exprs-norm_files/figure-latex/norm-ours-rle-downsample-1} 

}

\caption{Cell-wise RLE of the blischak data}(\#fig:norm-ours-rle-downsample)
\end{figure}
...
{\centering \includegraphics[width=0.9\linewidth]{12-exprs-norm_files/figure-latex/length-vs-mean-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{12-exprs-norm_files/figure-latex/norm-pca-fpkm-1} 
...
{\centering \includegraphics[width=0.9\linewidth]{12-exprs-norm_files/figure-latex/norm-pca-tpm-1} 

}

\caption{PCA plot of the blischak data after TPM normalisation}(\#fig:norm-pca-tpm)
\end{figure}
